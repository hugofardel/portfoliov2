	...
	return (
		<section className="flex flex-col sm:justify-between items-center sm:flex-row mt-12 md:mt-2">
			<div className="w-full md:w-2/5 text-left">
				...
				<p className="font-medium mt-4 text-lg md:text-xl lg:text-2xl xl:text-3xl text-center sm:text-left leading-normal text-gray-400">
				...
				<div className="flex justify-center sm:block">
					<a
						...
						className="font-medium flex justify-center items-center min-w-fit w-36 sm:w-48 mt-12 mb-6 sm:mb-0 text-lg border border-ternary-dark p-2.5 sm:p-3 shadow-lg rounded-lg bg-gray-50 focus:ring-1 focus:ring-indigo-900 hover:bg-indigo-500 text-gray-500 hover:text-white duration-500"
